...
export default function PolitiqueConfidentialitePage() {
  return (
    <div className="mx-auto max-w-2xl px-4 sm:px-6 py-8 sm:py-12 prose-sm">
      ...
      <h2 className="font-display text-lg font-semibold text-text-primary mt-6">Cookies</h2>
      <p className="text-text-primary mt-2 leading-relaxed">
      ...
      <h2 className="font-display text-lg font-semibold text-text-primary mt-6">Publicité</h2>
      <p className="text-text-primary mt-2 leading-relaxed">
