...
export default function MentionsLegalesPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 sm:px-6 py-8 sm:py-12 prose-sm">
      <h1 className="font-display text-3xl font-bold text-text-primary">Mentions légales</h1>

      <h2 className="font-display text-lg font-semibold text-text-primary mt-6">
        Éditeur du site
      </h2>
      ...
      <h2 className="font-display text-lg font-semibold text-text-primary mt-6">Hébergement</h2>
      <p className="text-text-primary mt-2 leading-relaxed">
